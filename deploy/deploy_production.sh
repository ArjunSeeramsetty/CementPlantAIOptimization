...
# Configuration
export PROJECT_ID="cement-ai-optimization"
export REGION="us-central1"
export ZONE="us-central1-a"
export SERVICE_NAME="cement-plant-digital-twin"
export IMAGE_NAME="cement-plant-ai"
export SERVICE_ACCOUNT="cement-ops@cement-ai-optimization.iam.gserviceaccount.com"
...
build_and_push_image() {
    log "🐳 Building and pushing container image via Google Cloud Build..."
    
    # Submit build to Cloud Build
    gcloud builds submit --tag gcr.io/$PROJECT_ID/$IMAGE_NAME:latest --timeout=15m --gcs-log-dir=gs://$PROJECT_ID-logs/build-logs
...
deploy_to_gke() {
    warn "Skipping GKE deployment (disabled for cost-optimization)"
    return
}
