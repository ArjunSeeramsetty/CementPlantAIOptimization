...
def main() -> None:
    ...
    reports = platform.validate(df)
    (outdir / "validation_reports.json").write_text(json.dumps(reports, indent=2, default=str))
    print("Validation complete. Reports in:", outdir)
